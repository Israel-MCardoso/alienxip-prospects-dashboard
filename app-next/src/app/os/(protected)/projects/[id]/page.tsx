...
export default async function ProjectDetailPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  const [{ project, tasks, activities }, notes, files, wikiLinks] = await Promise.all([
    getProject(id),
    getProjectNotes(id),
  ...
  return <ProjectWorkspace project={project} tasks={tasks} activities={activities} notes={notes.data} files={files.data} wikiPages={wikiLinks.pages} allWikiPages={wikiLinks.allPages} />;
}
